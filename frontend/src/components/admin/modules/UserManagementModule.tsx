...
export default function UserManagementModule({ role, targetRole }: UserManagementModuleProps) {
  ...
  const roleLabel =
    targetRole === 'super' ? 'Super Admin' : targetRole === 'master' ? 'Master' : 'Player';
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `${targetRole}_users.csv`;
    a.click();
  };
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage all {roleLabel.toLowerCase()} accounts
          </p>
        </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewUser({ ...newUser, commission_percentage: e.target.value })
                        }
                      />
                    </div>
                  </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>
                  <button className="flex items-center gap-1" onClick={() => handleSort('wallet_balance')}>
              ...
              {filteredUsers.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                    No {roleLabel.toLowerCase()} users found. Click "Refresh" to load data.
                  </TableCell>
                </TableRow>
              ) : (
                  ...
                  <TableRow key={u.id}>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-1">
                        ...
                        <Button variant="ghost" size="icon" title="Deposit">
