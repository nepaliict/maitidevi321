...
const recentReferrals = [
  { name: "Ra***sh K.", date: "2 days ago", status: "active", earned: "₹500" },
  { name: "Pr***ya S.", date: "5 days ago", status: "active", earned: "₹500" },
  { name: "Am***it G.", date: "1 week ago", status: "pending", earned: "₹0" },
  { name: "Su***ta M.", date: "1 week ago", status: "active", earned: "₹500" },
  { name: "Bi***al T.", date: "2 weeks ago", status: "active", earned: "₹500" },
];

export default function Affiliate() {
  const [referralCode] = useState("KARNALIX-JD123");
  const referralLink = `https://karnalix.com/ref/${referralCode}`;
  ...
  const currentTier = referralTiers.find(t => t.referrals > referralStats.totalReferrals) || referralTiers[0];
  const progress = (referralStats.totalReferrals / currentTier.referrals) * 100;
                ...
                <div className="mb-8 p-4 bg-muted/50 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {referralStats.totalReferrals}/{currentTier.referrals} referrals
                    </span>
                  </div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    {currentTier.referrals - referralStats.totalReferrals} more referrals to unlock {currentTier.perReferral}/referral
                  </p>
                </div>
