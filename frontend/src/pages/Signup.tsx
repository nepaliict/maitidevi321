...
import { Gamepad2, Mail, Lock, Eye, EyeOff, ArrowRight, User, Phone, Gift, Shield, CheckCircle } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <Button 
                ...
                disabled={step === 3 && (!formData.ageVerified || !formData.termsAccepted)}
              >
