...
const referrals: Referral[] = [
  { id: "1", name: "Rahul Sharma", email: "rahul@email.com", joinedAt: "2024-01-10", status: "active", earnings: 500, totalBets: 15000 },
  { id: "2", name: "Priya Singh", email: "priya@email.com", joinedAt: "2024-01-08", status: "active", earnings: 350, totalBets: 8500 },
  { id: "3", name: "Amit Kumar", email: "amit@email.com", joinedAt: "2024-01-05", status: "pending", earnings: 0, totalBets: 0 },
  { id: "4", name: "Sita Thapa", email: "sita@email.com", joinedAt: "2024-01-01", status: "inactive", earnings: 150, totalBets: 3000 },
];
      ...
      <div className="glass rounded-xl p-4 sm:p-6">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          <div className="text-center p-4">
            ...
            <p className="text-sm text-muted-foreground">Get ₹500 for each friend who deposits</p>
          </div>
        </div>
      </div>
